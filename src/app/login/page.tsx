...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Here we'll integrate with NextAuth
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white/10 backdrop-blur-lg rounded-3xl p-8 border border-white/20">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              ...
              className="w-full bg-white/10 text-white py-3 px-4 rounded-lg font-medium hover:bg-white/20 transition-all duration-200 border border-white/20 flex items-center justify-center space-x-3"
            >
        ...
        <div className="mt-8">
          <div className="bg-white/5 backdrop-blur-lg rounded-2xl p-6 border border-white/10 text-center">
            <h3 className="text-white font-semibold mb-2">Try Vulu for Free</h3>
            <p className="text-gray-300 text-sm mb-4">
              Experience our AI assistant with a demo account
            </p>
            <Link 
              href="/demo"
              className="inline-block bg-white/10 text-white px-6 py-2 rounded-lg font-medium hover:bg-white/20 transition-all duration-200 border border-white/20"
            >
              Start Demo
            </Link>
          </div>
